...
cmap_div = mpl.colors.LinearSegmentedColormap("lab_div", cdict_div)
cmap_seqp = mpl.colors.LinearSegmentedColormap("lab_seqplus", cdict_monl_orange)
cmap_seqm = mpl.colors.LinearSegmentedColormap("lab_seqminus", cdict_monr_blue)
